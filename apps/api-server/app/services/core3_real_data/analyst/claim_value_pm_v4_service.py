"""Deterministic reason -> realized value -> sellpoint bundle linkage.

G04 consumes the immutable V4 context. It never creates purchase reasons,
infers pre-purchase communication mindsets, builds counterfactuals, or assigns
money to comments or capabilities.
"""
...
__all__ = ["build_reason_value_bundle_links"]
