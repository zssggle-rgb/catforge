    ...
    return M09CUserTaskTaxonomy(
        ...
        user_tasks=(
            _task(
                ...
                ("use_living_room_cinema", "audience_child_family", "picture_clarity_resolution", "system_smooth_ads", "audio_quality"),
                ("客厅", "家庭", "全家", "追剧", "综艺", "日常看", "看电视"),
                ("medium_46_59", "large_60_69", "xlarge_70_85"),
                ("low", "mid_low", "mid", "mid_high"),
                ("tv_claim_theater_scene", "tv_claim_hdr_high_brightness", "tv_claim_speaker_sound", "tv_claim_eye_care_display", "tv_claim_voice_control", "tv_claim_value_price"),
                ("screen_size_inch", "resolution_class", "hdr_support_flag", "memory_capacity_gb", "speaker_power_w", "smart_tv_flag"),
            ...
            _task(
                ...
                ("use_living_room_cinema", "audio_quality", "picture_brightness_hdr", "picture_local_dimming_black", "appearance_size_fit"),
                ("电影", "影院", "大片", "沉浸", "震撼", "大屏", "音效"),
                ("large_60_69", "xlarge_70_85", "giant_98_plus"),
                ("mid", "mid_high", "high"),
                ("tv_claim_theater_scene", "tv_claim_dolby_audio_video", "tv_claim_hdr_high_brightness", "tv_claim_local_dimming", "tv_claim_speaker_sound", "tv_claim_miniled_display"),
                ("screen_size_inch", "hdr_support_flag", "declared_brightness_nit_or_band", "speaker_power_w", "display_tech_class", "local_dimming_zone_count"),
            ...
            _task(
                ...
                ("picture_clarity_resolution", "picture_brightness_hdr", "picture_color_accuracy", "picture_local_dimming_black"),
                ("画质", "亮度", "控光", "色彩", "黑位", "miniled", "oled", "量子点", "画质芯片"),
                ("large_60_69", "xlarge_70_85"),
                ("mid_high", "high"),
                ("tv_claim_miniled_display", "tv_claim_qd_miniled_display", "tv_claim_rgb_miniled_display", "tv_claim_oled_self_lit", "tv_claim_hdr_high_brightness", "tv_claim_wide_color_accuracy", "tv_claim_local_dimming", "tv_claim_picture_engine_ai"),
                ("display_tech_class", "declared_brightness_nit_or_band", "local_dimming_zone_count", "color_gamut_percent", "picture_engine_chip", "hdr_support_flag"),
            ...
            _task(
                ...
                ("换新", "换电视", "旧电视", "升级", "大屏", "75", "85", "98", "尺寸大"),
                ("xlarge_70_85", "giant_98_plus"),
                ("low", "mid_low", "mid", "mid_high"),
                ("tv_claim_theater_scene", "tv_claim_value_price", "tv_claim_full_screen_design", "tv_claim_hdr_high_brightness"),
                ("screen_size_inch", "resolution_class", "price_per_inch", "full_screen_design_flag"),
            ...
            _task(
                ...
                ("游戏", "主机", "ps5", "xbox", "switch", "高刷", "低延迟", "hdmi2.1", "vrr"),
                ...
                ("declared_refresh_rate_hz", "hdmi21_flag", "vrr_allm_flag", "memc_motion_flag", "memory_capacity_gb"),
                adjacent_price_bands=("mid_low",),
            ),
            _task(
                ...
                ("use_gaming_sports", "gaming_high_refresh_motion", "picture_clarity_resolution"),
                ("体育", "赛事", "看球", "足球", "篮球", "运动", "赛车", "流畅", "拖影"),
                ("medium_46_59", "large_60_69", "xlarge_70_85", "giant_98_plus"),
                ("mid_low", "mid", "mid_high", "high"),
                ("tv_claim_high_refresh_rate", "tv_claim_gaming_low_latency", "tv_claim_hdr_high_brightness"),
                ("declared_refresh_rate_hz", "memc_motion_flag", "vrr_allm_flag", "declared_brightness_nit_or_band"),
            ),
            _task(
                ...
                ("孩子", "儿童", "护眼", "低蓝光", "无频闪", "不刺眼", "长时间", "眼睛", "舒服"),
                ("small_32_45", "medium_46_59", "large_60_69"),
                ("mid_low", "mid", "mid_high", "high"),
                ("tv_claim_eye_care_display", "tv_claim_hdr_high_brightness", "tv_claim_wide_color_accuracy"),
                ("eye_care_certification_flag", "low_blue_light_flag", "flicker_free_flag", "declared_refresh_rate_hz", "hdr_support_flag"),
            ...
            _task(
                ...
                ("老人", "父母", "爸妈", "长辈", "语音", "遥控", "广告少", "操作简单", "系统清爽"),
                ("small_32_45", "medium_46_59", "large_60_69"),
                ("low", "mid_low", "mid"),
            ...
            _task(
                ...
                ("screen_size_inch", "resolution_class", "smart_tv_flag", "price_per_inch", "voice_recognition_flag"),
                adjacent_size_tiers=("medium_46_59",),
                adjacent_price_bands=("mid",),
            ),
            _task(
                ...
                ("wifi_builtin_flag", "network_tv_flag", "smart_tv_flag", "ai_large_model_flag", "voice_recognition_flag", "far_field_voice_flag", "iot_control_flag", "camera_builtin_flag"),
                adjacent_size_tiers=("small_32_45",),
                adjacent_price_bands=("mid_low",),
            ),
            _task(
                ...
                ("appearance_slim_wall", "appearance_size_fit", "use_living_room_cinema"),
                ("新家", "装修", "客厅布置", "贴墙", "超薄", "全面屏", "外观", "空间"),
                CANONICAL_SIZE_TIERS,
                ("mid_low", "mid", "mid_high", "high"),
                ("tv_claim_full_screen_design", "tv_claim_flush_wall_mount", "tv_claim_ultra_thin_design", "tv_claim_theater_scene"),
                ("full_screen_design_flag", "flush_wall_mount_flag", "ultra_thin_flag", "screen_size_inch"),
                adjacent_price_bands=("low",),
            ),
            _task(
...
class M09CUserTaskTaxonomyLoader:
    def load(self, taxonomy_version: str, *, product_category: str) -> M09CUserTaskTaxonomy:
        normalized_category = str(product_category or "").upper()
        if normalized_category == "TV" and taxonomy_version == CORE3_M09C_TV_TAXONOMY_VERSION:
            return tv_user_task_taxonomy_v0_1()
        raise ValueError(f"{normalized_category or product_category} 用户任务 taxonomy 未发布，不能生成 M09C 用户任务画像。")
...
class M09CUserTaskRepository(ParamExtractionRepository):
    ...
    def save_scores(self, scores: Sequence[Any], *, replace_on_hash_conflict: bool = False) -> ParamRepositoryWriteResult:
        return self._save_many(
            ...
            scores,
            unique_fields=("batch_id", "taxonomy_version", "sku_code", "user_task_code", "rule_version", "is_current"),
    ...
    def save_coverages(self, coverages: Sequence[Any], *, replace_on_hash_conflict: bool = False) -> ParamRepositoryWriteResult:
        return self._save_many(
            ...
            coverages,
            unique_fields=("batch_id", "taxonomy_version", "user_task_code", "rule_version", "is_current"),
...
class M09CRunner:
    ...
    def run(self, context: Core3RunContext, target: Core3ModuleTarget) -> Core3ModuleRunResultSchema:
        ...
        return self.run_batch(
            ...
            taxonomy_version=str(target.metadata.get("taxonomy_version") or CORE3_M09C_TV_TAXONOMY_VERSION),
            rule_version=str(target.metadata.get("rule_version") or CORE3_M09C_TV_RULE_VERSION),
        ...
        *,
        ...
        return Core3ModuleRunResultSchema(
            ...
            downstream_impacts=[
                ...
                {"module_code": "M11C", "reason": "用户任务变化会影响价值战场解释和后续竞品库。"},
                {"module_code": "M12", "reason": "用户任务变化会影响竞品召回和候选池解释。"},
            ],
...
class M09CService:
    ...
    def build_batch(
        ...
        *,
        ...
        taxonomy = M09CUserTaskTaxonomyLoader().load(taxonomy_version, product_category=product_category)
        ...
        write_results = {
            "user_task_profiles": repository.save_profiles(profiles, replace_on_hash_conflict=force_rebuild),
            "user_task_scores": repository.save_scores(scores, replace_on_hash_conflict=force_rebuild),
            "user_task_coverages": repository.save_coverages(coverages, replace_on_hash_conflict=force_rebuild),
        }
        warnings: list[str] = []
        if not sku_inputs:
...
class M09CProfileBuilder:
    ...
    def build(
    ...
    ) -> tuple[list[M09CWritePayload], list[M09CWritePayload], list[M09CWritePayload], dict[str, Any]]:
        ...
        for sku_input in sku_inputs:
            sku_scores = [self._score_user_task(sku_input, user_task) for user_task in self.user_tasks]
            sku_scores = self._assign_primary_secondary(sku_scores)
            scores.extend(M09CWritePayload(payload) for payload in sku_scores)
            profiles.append(M09CWritePayload(self._profile_payload(sku_input, sku_scores)))
        ...
        coverages = [M09CWritePayload(payload) for payload in self._coverage_payloads(score_payloads)]
        summary = {
    ...
    def _score_user_task(self, sku_input: M09CSkuInput, user_task: M09CUserTaskDefinition) -> dict[str, Any]:
        ...
        claim_match = _claim_match(sku_input.claim_facts, sku_input.claim_profile, user_task)
        param_match = _param_match(sku_input.param_profile, sku_input.market_profile, user_task)
        ...
        payload = {
            "score_id": _score_id(self.project_id, self.batch_id, self.taxonomy.taxonomy_version, sku_input.sku_code, user_task.user_task_code, self.rule_version),
            ...
            "confidence": _confidence(size_price_fit_score, comment_score, claim_score, param_score, sku_input),
            "is_current": True,
        }
    ...
    def _assign_primary_secondary(self, score_payloads: list[dict[str, Any]]) -> list[dict[str, Any]]:
        eligible = [
            ...
            and payload["score_breakdown_json"]["size_price"]["gate_status"] in {"matched", "adjacent", "unknown"}
        ]
        eligible.sort(
            key=lambda item: (
        ...
        if eligible:
            ...
            eligible[0]["status_reason_cn"] = eligible[0]["status_reason_cn"].replace("可作为候选用户任务", "作为主用户任务")
        ...
        for payload in secondary[2:]:
            ...
            payload["status_reason_cn"] = f"{payload['user_task_name']}证据成立但已超出最多两个次用户任务限制，降为潜在能力任务。"
            payload["result_hash"] = _score_result_hash(payload, self.taxonomy.taxonomy_version, self.rule_version)
        return score_payloads

    def _profile_payload(self, sku_input: M09CSkuInput, score_payloads: Sequence[dict[str, Any]]) -> dict[str, Any]:
        ...
        payload = {
            ...
            "secondary_user_task_codes_json": [item["user_task_code"] for item in secondary],
            "comment_observed_task_codes_json": [item["user_task_code"] for item in observed],
            "brand_claimed_task_codes_json": [item["user_task_code"] for item in claimed],
            "latent_capability_task_codes_json": [item["user_task_code"] for item in latent],
    ...
    def _coverage_payloads(self, score_payloads: Sequence[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        for user_task in self.user_tasks:
            rows = [item for item in score_payloads if item["user_task_code"] == user_task.user_task_code and item["relation_status"] != REL_NOT_SUPPORTED]
            status_counts = Counter(item["relation_status"] for item in rows)
            top_skus = sorted(rows, key=lambda item: item["user_task_score"], reverse=True)[:30]
            payload = {
                "coverage_id": _coverage_id(self.project_id, self.batch_id, self.taxonomy.taxonomy_version, user_task.user_task_code, self.rule_version),
                "project_id": self.project_id,
                "category_code": self.category_code,
                "batch_id": self.batch_id,
                "run_id": self.run_id,
                ...
                "latent_capability_sku_codes_json": [item["sku_code"] for item in rows if item["relation_status"] == REL_LATENT],
                "drag_factor_sku_codes_json": [item["sku_code"] for item in rows if item["relation_status"] == REL_DRAG],
...
def _filter_user_tasks(
    ...
    return tuple(item for item in taxonomy.user_tasks if item.user_task_code in code_set)
...
def _size_price_gate_status(sku_input: M09CSkuInput, user_task: M09CUserTaskDefinition) -> str:
    ...
    if size_ok and price_ok:
        return "matched"
    if (size_ok and sku_input.price_band_in_size_tier in user_task.adjacent_price_bands) or (
        price_ok and sku_input.size_tier in user_task.adjacent_size_tiers
    ):
        return "adjacent"
    return "mismatch"
...
def _comment_match(comment_facts: Sequence[entities.Core3CommentFactAtom], user_task: M09CUserTaskDefinition) -> dict[str, Any]:
    wanted = set(user_task.comment_subdimension_codes)
    rows = [
        row
        for row in comment_facts
        if not _is_service_comment(row)
        and (row.subdimension_code in wanted or _keyword_match(row.clean_comment_text, user_task.comment_keywords))
    ]
...
def _negative_drag_score(
    ...
    base = Decimal("0.4500") if negative_count >= max(1, positive_count) else Decimal("0.2500")
    if set(comment_match.get("contradicted_claim_codes") or []) & set(claim_match.get("matched_claim_codes") or []):
        base += Decimal("0.2500")
    if set(comment_match.get("contradicted_param_codes") or []) & set(param_match.get("supported_param_codes") or []):
        base += Decimal("0.2500")
...
def _initial_relation_status(
    *,
    ...
    if negative_count > 0 and negative_count >= max(1, positive_count) and comment_score >= Decimal("0.5000"):
        return REL_DRAG
    ...
    if comment_score >= Decimal("0.6200") and (claim_score < Decimal("0.2500") or param_score < Decimal("0.2500")):
        return REL_COMMENT_OBSERVED
    if claim_score >= Decimal("0.5000") and param_score >= Decimal("0.4000") and comment_score < Decimal("0.3500"):
    ...
    if param_score >= Decimal("0.4500") and size_price_gate_status in {"matched", "adjacent"} and comment_score < Decimal("0.3500"):
        return REL_LATENT
    if score >= Decimal("0.4000") and size_price_gate_status in {"matched", "adjacent", "unknown"}:
        return REL_LATENT
    return REL_NOT_SUPPORTED
...
def _no_primary_reason(score_payloads: Sequence[dict[str, Any]], sku_input: M09CSkuInput) -> str:
    comment_hits = [item for item in score_payloads if item["comment_task_need_score"] >= Decimal("0.5200")]
    brand_hits = [item for item in score_payloads if item["relation_status"] == REL_BRAND_CLAIMED]
...
def _comment_summary(score_payloads: Sequence[dict[str, Any]]) -> dict[str, Any]:
    supported = [
        ...
        if item["comment_task_need_score"] > Decimal("0.0000") and item["relation_status"] != REL_NOT_SUPPORTED
    ]
    return {
        "matched_task_count": len(supported),
        "top_comment_tasks": [_compact_score(item) for item in sorted(supported, key=lambda row: row["comment_task_need_score"], reverse=True)[:5]],
    }


def _claim_param_summary(score_payloads: Sequence[dict[str, Any]]) -> dict[str, Any]:
    return {
        "brand_claimed_task_count": sum(1 for item in score_payloads if item["relation_status"] == REL_BRAND_CLAIMED),
        "latent_capability_task_count": sum(1 for item in score_payloads if item["relation_status"] == REL_LATENT),
        "drag_factor_task_count": sum(1 for item in score_payloads if item["relation_status"] == REL_DRAG),
    }
...
def _score_id(project_id: str, batch_id: str, taxonomy_version: str, sku_code: str, user_task_code: str, rule_version: str) -> str:
    return stable_hash(
        {
            "project_id": project_id,
            "batch_id": batch_id,
...
def _coverage_id(project_id: str, batch_id: str, taxonomy_version: str, user_task_code: str, rule_version: str) -> str:
    return stable_hash(
        {
            "project_id": project_id,
            "batch_id": batch_id,
