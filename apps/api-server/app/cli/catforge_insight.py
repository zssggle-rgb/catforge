        ...
        result["claim_facts"] = [
            {
                ...
                "param_support_level": getattr(row, "param_support_level", None),
                "param_support_specificity": getattr(row, "param_support_specificity", None),
                "supporting_param_codes": row.supporting_param_codes or [],
                "primary_supporting_param_codes": getattr(row, "primary_supporting_param_codes", None) or [],
                "generic_support_param_codes": getattr(row, "generic_support_param_codes", None) or [],
                "canonical_claim_code": getattr(row, "canonical_claim_code", None) or row.claim_code,
                "canonical_claim_name": getattr(row, "canonical_claim_name", None) or row.claim_name,
                ...
                "wtp_input_guard": getattr(row, "wtp_input_guard", None),
