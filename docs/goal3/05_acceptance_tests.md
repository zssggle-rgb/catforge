...
Acceptance is scoped to internal category asset production, review, calibration, release gating, and runtime asset export preview. It is not scoped to a customer-facing portal.
