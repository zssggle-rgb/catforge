...
These APIs serve the internal CatForge production workbench. Runtime export APIs expose only approved runtime assets and must not expose factory-only generation logic.
