...
19. [M11C 新价值战场画像与图谱](M11C_value_battlefield_profile_requirements.md)
20. [M11.5 战场内卖点价值分层](M11_5_claim_value_layer_requirements.md)
21. [M12 候选池召回模块](M12_candidate_recall_requirements.md)
22. [M13 竞品组件评分模块](M13_component_scoring_requirements.md)
23. [M14 三槽位核心竞品选择](M14_core3_selection_requirements.md)
24. [M15 证据卡与高层报告](M15_evidence_report_requirements.md)
25. [M16 增量任务编排、复核和验收](M16_incremental_review_acceptance_requirements.md)
