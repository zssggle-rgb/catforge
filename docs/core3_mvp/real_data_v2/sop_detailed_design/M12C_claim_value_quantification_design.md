...
只有 L0-L3 全部失败后，才能输出“样本不足待复核”。如果 L4 只能证明同类产品普遍具备该卖点，应输出门槛或待验证，不得输出高溢价。
...
| MT9655/画质芯片/处理器性能 | 高溢价候选/需复核 | 与画质处理、控光、高刷和智能体验相关，但芯片型号同池样本稀疏 |
...
| MT9655/画质芯片/处理器性能 | 高溢价候选/需复核 | 示例约 50-70 元/台 | 支撑画质处理和高阶体验，但芯片样本稀疏，需降级说明 |
