...
Top 3 集合不能机械取最高分前三名，必须先保证业务解释完整：

1. 先选择最高分的首选直接竞品。
2. 再选择强直接竞品或配置标杆型竞品。
3. 第三名优先选择具有明确战略压力的下探分流、上探替代或价格贴身竞品。

角色槽位只用于确定“哪三款进入 Top 3”，不得直接作为最终名次。集合确定后必须无条件按 `competitor_business_score` 降序重新排名，同分时依次比较直接竞争关系、市场验证等级、购买池得分和价格接近度。关键价值锚点和替代压力门槛只能限制竞品角色及强替代话术，不能改变名次。因此报告中的“综合分”和“排名”必须保持一致，不能出现低分候选排在高分候选之前。
...
- 主回答是卡片看板，飞书文档是佐证入口。
- 第一屏必须看见目标 SKU、Top 3 竞品、角色和综合竞争强度；替代压力保留在详细分析，不作为顶部独立字段。
...
| 销量相近 | 不得单独让候选成为首选竞品。 |
| Top 3 选择 | 能同时覆盖直接、强直接、下探/价格贴身等角色；入选集合最终按综合分降序排列。 |
| 短摘要长度 | 不超过 600 中文字符。 |
...
- 飞书佐证文档标题下必须同步插入 Markdown 版“重点竞品看板”，字段与 `dashboard_payload` 同源，先展示 Top 3、角色、重合强度和市场验证；顶部不单列替代压力。价值战场、用户任务、目标客群、关键价值锚点可替代性和替代压力的完整比较放在详细分析章节。
...
- 看板：Top 3、相对排名、角色、竞争成立程度和市场验证；不单列替代压力。
