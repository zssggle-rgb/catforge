...
| ClaimValueEvidenceAssembler | 读取目标和候选 SKU 的 M12C 卖点价值量化，形成报告可直接展示的业务卖点标签、可比池卖点价格/销量差异、本品超额表现解释份额和拖后腿/机会缺口。 |
...
- `sku-claim-value`：单 SKU 的 SKU×卖点价值角色、可比池卖点价格/销量/销额差异、本品超额表现解释份额和置信度。
...
2. 本品超额表现解释份额：本品相对同池基准的超额价格、周均销量或周均销额，按卖点证据权重做解释性分摊。
...
| 行 | 内容 |
| --- | --- |
| Top5 卖点价值 | 展示每个 SKU 最重要的 5 个卖点及业务标签，例如 `MiniLED（强溢价卖点）；高刷（强销量卖点）`。 |
| 强溢价卖点 | 展示池价差、池销量差和本品超额解释份额。 |
| 强销量卖点 | 展示池销量差、销额差和本品超额销量解释份额。 |
| 组合型增值卖点 | 展示与主战场、主任务、主客群共同构成成交理由的卖点。 |
| 基础门槛卖点 | 展示同池普遍具备、缺失会拖累但不单独加价的卖点。 |
| 用户感知不足/拖后腿 | 展示不得作为价格支撑或正向分摊的卖点。 |
| 高价竞品拦截/上探机会 | 展示竞品具备、本品缺失或表达弱的机会卖点。 |
...
横向详细对比必须包含市场画像、价值战场画像、用户任务画像、目标客群画像、卖点画像、参数画像和卖点价值量化。卖点画像只展示事实和证据；卖点价值量化独立展示 M12C 的 Top5 卖点价值、可比池卖点价格/销量差异、本品超额表现解释份额和拖后腿/机会缺口。
...
| M12C 报告接入 | 竞品报告新增独立“卖点价值量化”章节，展示业务卖点标签、可比池差异、本品超额解释份额和置信度。 |
