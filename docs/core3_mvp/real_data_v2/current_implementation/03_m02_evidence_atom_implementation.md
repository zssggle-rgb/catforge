...
本文档记录 `hotfix/data-preprocess-20260618` 分支中 M02 的当前实现。M02 是事实分析前的 evidence 原子层：它只把 M01 清洗事实转成可追踪 evidence，不生成业务画像、用户任务、目标客群、价值战场或竞品结论。
...
2. 重复评论中的非代表评论。
3. 模板类非业务评论，例如“好”“很好”“不错”“满意”“此用户未及时填写评价内容”等。
4. 包含非业务服务模板的评论，例如“送装一体”“京东服务”等。
...
- M02 过滤规则仍是规则型快速过滤，复杂服务/产品混合评论需要后续 M05/M06 进一步判断。
