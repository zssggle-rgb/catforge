...
- TV：[海信 65E7Q 重点竞品识别与分析依据报告](https://my.feishu.cn/docx/UtJOdRDXzo8szOxuFKucg7iIn8b)
...
最终验证包括 M12D/reader/竞品相关回归 `106 passed`、完整 CLI 报告回归 `1 passed`，以及报告口径修正回归 `16 passed`、顶部看板定向回归 `3 passed`、压力列修正定向回归 `2 passed`、Ruff、compileall、飞书文档回读、API 健康和日志检查。205 当前应用 Git revision 为 `54090b6`，Alembic 为 `0044_core3_m12d_reason_pressure`。
