...
description: Query CatForge SKU parameter fact profiles, TV standard parameters, and parameter tier SKU coverage using natural language.
---
...
- A SKU/model's parameter fact profile, for example "查 100A4F 的参数画像", "TV00027354 参数情况", "这个 SKU 的硬件参数是什么".
- TV standard parameters, for example "彩电有哪些标准参数", "查彩电标准参数表", "MiniLED 对应哪些原始字段".
- Parameter tier coverage, for example "MiniLED 档位覆盖哪些 SKU", "旗舰画质有哪些 SKU", "一级能效覆盖 SKU".
